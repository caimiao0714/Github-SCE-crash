...
This website serves as the supplementary materials for the manuscript *The association between crashes and safety-critical events: synthesized evidence from crash reports and naturalistic driving data among commercial truck drivers* by Miao Cai, Mohammad Ali Alamdar Yazdi, Amir Mehdizadeh, Qiong Hu, Alexander Vinel, Karen Davis, Fadel Megahed, Hong Xian, and Steven Rigdon. It has been submitted to [Transportation Research Part C: Emerging Technologies](https://www.journals.elsevier.com/transportation-research-part-c-emerging-technologies).
